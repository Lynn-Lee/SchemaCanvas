...
SchemaCanvas 应定位为“隐私优先、无需账号、可离线使用的数据库结构设计与 SQL 生成工具”。
...
4. 强制账号登录。
5. 把 SchemaCanvas 改成通用 BI 或数据库管理平台。
6. 生产数据库直连和执行 SQL。
