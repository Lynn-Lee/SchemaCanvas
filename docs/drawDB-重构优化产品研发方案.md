...
6. 大图 benchmark。（Phase 4.6 已完成 100、500、1000 表 deterministic fixtures；Phase 4.9 继续补 500 表加载与搜索 smoke。）
7. 评估视口裁剪或 SVG 分层。
